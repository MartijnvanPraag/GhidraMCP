...
import au.federation.ghidra.api.GhidraJsonEndpoint;
import au.federation.ghidra.api.ResponseBuilder; // Import ResponseBuilder
import au.federation.ghidra.util.GhidraUtil; // Import GhidraUtil
import au.federation.ghidra.util.HttpUtil; // Import HttpUtil
...
public abstract class AbstractEndpoint implements GhidraJsonEndpoint {
    ...
    protected <T> List<T> applyPagination(List<T> items, int offset, int limit, 
            au.federation.ghidra.api.ResponseBuilder builder, String basePath, String additionalQueryParams) {
        // Apply pagination
     ...
     */
    protected <T> List<T> applyPagination(List<T> items, int offset, int limit, 
            au.federation.ghidra.api.ResponseBuilder builder, String basePath) {
