#!/usr/bin/env python3
"""
Test runner for GhidraMCP tests.
...
def run_http_api_tests():
    ...
    try:
        from test_http_api import GhidraMCPHttpApiTests
        
        # Create a test suite with all tests from GhidraMCPHttpApiTests
        suite = unittest.TestLoader().loadTestsFromTestCase(GhidraMCPHttpApiTests)
...
def run_all_tests():
    """Run all tests"""
    print_header("GhidraMCP Test Suite")
