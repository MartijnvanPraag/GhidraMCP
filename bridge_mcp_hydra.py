...
# ]
# ///
# GhidraMCP Bridge for Ghidra HATEOAS API - Optimized for MCP integration
...
mcp = FastMCP("GhidraMCP", version=BRIDGE_VERSION, instructions=instructions)
...
def _discover_instances(port_range, host=None, timeout=0.5) -> dict:
    ...
    for port in port_range:
        ...
        try:
            ...
            if response.ok:
                # Further validate it's a GhidraMCP instance by checking response format
                try:
