#!/usr/bin/env python3
"""
Test script for the GhidraMCP HTTP API.
...
GhidraMCP_TEST_HOST = os.getenv('GhidraMCP_TEST_HOST')
if GhidraMCP_TEST_HOST and GhidraMCP_TEST_HOST.strip():
    BASE_URL = f"http://{GhidraMCP_TEST_HOST}:{DEFAULT_PORT}"
else:
...
class GhidraMCPHttpApiTests(unittest.TestCase):
    """Test cases for the GhidraMCP HTTP API"""
