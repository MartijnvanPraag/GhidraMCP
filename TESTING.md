...
This document describes how to test the GhidraMCP plugin and bridge.

## Prerequisites

- Python 3.11 or higher
- Ghidra with the GhidraMCP plugin installed and running
...
1. Make sure Ghidra is running with the GhidraMCP plugin loaded
2. Run the tests:
...
- If tests are skipped with "Ghidra server not running or not accessible", make sure Ghidra is running and the GhidraMCP plugin is loaded.
...
1. Add a new test method to the `GhidraMCPHttpApiTests` class
